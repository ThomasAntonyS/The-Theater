  ...
  return (
    <section className="relative max-w-[1400px] px-6 md:px-10 bg-transparent text-white overflow-hidden py-16 mx-auto">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* ROW 1: Image & Main Details (Aligned to top) */}
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-20 items-start">
          
          {/* Sticky Poster Container */}
          <div className="hidden lg:block w-[400px] flex-shrink-0 sticky top-28" data-aos="zoom-out" data-aos-duration="1200">
          ...
          {/* Content Section (Row 1 details) */}
          <div className="flex-1 space-y-8 min-w-0 my-auto">
            ...
            <div className="space-y-6">
              <p className="text-lg text-white/70 font-nunito leading-relaxed max-w-4xl text-justify line-clamp-5">
                {overview}
              </p>
        ...
        {/* ROW 2: Metadata Cards, Collections, and Studios (Starts below the image) */}
        <div className="mt-16 space-y-8">

          {/* Financial & Metadata Info Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 space-y-4">
              <div className="flex items-center gap-3">
                <GiCash className="text-red-600" size={26} />
                <div>
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-white/5">
                <LiaMoneyBillWaveSolid className="text-red-600" size={26} />
                <div>
          ...
          {belongs_to_collection && (
            <Link 
              ...
              onClick={handleScrollTop}
              className="group block p-5 rounded-xl bg-white/[0.02] hover:bg-white/[0.05] border border-red-600/50 transition-all"
            >
              ...
              {showAllStudios && (
                <div className="mt-6 flex flex-wrap gap-x-6 gap-y-3 animate-in fade-in slide-in-from-top-2 duration-500">
                  ...
                  <button 
                    ...
                    className="text-[10px] font-manrope font-black text-red-600 uppercase tracking-wide underline ml-2"
                  >
                    Show Less
                  </button>
                </div>
