...
const MovieProviders = ({ movieId }) => {
  ...
  if (loading) {
    return <p className="text-white text-center font-nunito text-lg">Loading providers...</p>;
  }

  if (error) {
    return <p className="text-red-500 text-center font-nunito text-lg">Error: {error.message}</p>;
  }
