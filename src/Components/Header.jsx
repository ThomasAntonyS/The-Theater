    ...
    <div>
        <div className="fixed font-manrope top-0 flex align-middle justify-between h-[10vh] w-[100vw] overflow-x-hidden bg-black bg-opacity-70 z-[100] px-4">
            ...
            <div className="hidden lg:flex gap-2 text-white">
                <Link  className='h-max w-max my-auto hover:opacity-70' to='/popular'>Popular</Link>
                <span  className='h-max my-auto'>|</span>
                <Link  className='h-max w-max my-auto hover:opacity-70' to='/top_rated'>Top-Rated</Link>
                <span  className='h-max my-auto'>|</span>
                <Link  className='h-max w-max my-auto hover:opacity-70' to='/upcoming'>Upcoming</Link>
            </div>
            ...
            <div className=" flex text-white">
                <Link className='h-max w-max my-auto p-2 rounded-full hover:bg-white hover:bg-opacity-25' to='/search'>
                {(window.screen.width<640)?<SearchIcon fontSize='small' /> : <SearchIcon/>}
                </Link> 

                <Link className='h-max w-max my-auto p-2 rounded-full  hover:bg-white hover:bg-opacity-25' to='/watchlist'>
                ...
                <div className='LogIn_Out_section flex flex-row align-middle h-max my-auto'>
                    <Link className='h-max w-max my-auto p-2 rounded-full  hover:bg-white hover:bg-opacity-25' to='/sign_up'>
                    {(window.screen.width<640)?<LoginIcon fontSize='small'/> : <LoginIcon/>}
                    </Link>

                    <p className=' w-max h-max my-auto'>|</p>

                    <button className='h-max w-max my-auto p-2 rounded-full  hover:bg-white hover:bg-opacity-25' onClick={handleLogout}>
