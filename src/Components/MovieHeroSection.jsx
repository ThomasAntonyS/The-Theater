      ...
      <div className="absolute bottom-5 w-full z-10 flex flex-col px-4 sm:px-6 md:px-12 lg:px-16 ">
        <div className="flex flex-col flex-grow">
          <div className="flex flex-col sm:justify-between gap-4">
            ...
            <h3 className=" text-lg sm:text-xl md:text-2xl font-nunito  line-clamp-2">{item.overview}</h3>
          </div>
        </div>

        <div className="mt-5 py-4 text-gray-300 text-sm rounded-md">
          <div className="flex flex-col md:flex-row md:justify-between gap-4">
            <div className="flex flex-wrap text-lg sm:text-xl md:text-2xl align-middle gap-4 font-nunito">
              <p className="h-max my-auto">
                <span className="text-red-500 font-semibold">Release Date:</span>{' '}
                {formatDate(item.release_date)}
              </p>
              <p className="h-max my-auto text-lg sm:text-xl md:text-2xl">
            ...
            <button
              ...
              className="flex h-max w-max my-auto text-lg sm:text-xl md:text-2xl bg-red-600 hover:bg-red-700 font-nunito text-white px-4 py-2 rounded-md sm:w-max"
            >
