...
const Sign_In = () => {
  ...
  const {setUserEmail,setLoggedIn} = useContext(ProfileContext)
  ...
  return (
    <div className='Sign_Up relative h-[100vh] bg-white'>
      ...
      <section className=' absolute flex flex-col h-[60vh] w-[23vw] bg-black bg-opacity-75 rounded top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 '>
          ...
          <button 
          className=' w-[50%] h-max mx-auto p-2 rounded text-white mt-14 bg-white bg-opacity-15 hover:bg-opacity-25'
